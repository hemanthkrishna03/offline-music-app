...
const songs = [
  ...
  { title: "Maguva Maguva", file: "songs/Maguva(Male).mp3" },
  ...
  { title: "Aasia Khantamlo", file: "songs/Aasia_Khantamlo.mp3" },
  { title: "Aa Roje Tholisari", file: "songs/Aa_Roje_Tholisari.mp3" },
  { title: "Adaragottu Kottu", file: "songs/Adaragottu_Kottu.mp3" },
  { title: "Akdi Pakdi", file: "songs/Akdi_Pakdi.mp3" },
  { title: "Alludu Adhursm", file: "songs/Alludu_Adhursm.mp3" },
  { title: "Alludu Seenu", file: "songs/Alludu_Seenu.mp3" },
  { title: "All Most Padipoyi", file: "songs/All_Most_Padipoyi.mp3" },
  { title: "Ammayi Kitiki", file: "songs/Ammayi_Kitiki.mp3" },
  { title: "Anaganaga Oka Uru", file: "songs/Anaganaga_Oka_Uru.mp3" },
  { title: "Andala Aakashaman", file: "songs/Andala_Aakashaman.mp3" },
  { title: "Anjaneyudu Neev", file: "songs/Anjaneyudu_Neev.mp3" },
  { title: "Aradhya", file: "songs/Aradhya.mp3" },
  { title: "Arere Chandrakala", file: "songs/Arere_Chandrakala.mp3" },
  { title: "Atta Sudake", file: "songs/Atta_Sudake.mp3" },
  { title: "Atto Attamma Koot", file: "songs/Atto_Attamma_Koot.mp3" },
  { title: "Azaadi", file: "songs/Azaadi.mp3" },
  { title: "A For Apple", file: "songs/A_For_Apple.mp3" },
  { title: "Babu Rambabu", file: "songs/Babu_Rambabu.mp3" },
  { title: "Bellam Sridevi", file: "songs/Bellam_Sridevi.mp3" },
  { title: "Bhajarangabali", file: "songs/Bhajarangabali.mp3" },
  { title: "Bhalegundi Baalaam", file: "songs/Bhalegundi_Baalaam.mp3" },
  { title: "Bimbisara Rap", file: "songs/Bimbisara_Rap.mp3" },
  { title: "Blackberry", file: "songs/Blackberry.mp3" },
  { title: "Bulreddy", file: "songs/Bulreddy.mp3" },
  { title: "Chalo Chalo", file: "songs/Chalo_Chalo.mp3" },
  { title: "Chandrullo Unde", file: "songs/Chandrullo_Unde.mp3" },
  { title: "Changubhala", file: "songs/Changubhala.mp3" },
  { title: "Chirunama Thana", file: "songs/Chirunama_Thana.mp3" },
  { title: "Chiru Chiru Navvula", file: "songs/Chiru_Chiru_Navvula.mp3" },
  { title: "Choopulatho", file: "songs/Choopulatho.mp3" },
  { title: "Choopultho", file: "songs/Choopultho.mp3" },
  { title: "Choosi Chudangane", file: "songs/Choosi_Chudangane.mp3" },
  { title: "Chupulatho Deepala", file: "songs/Chupulatho_Deepala.mp3" },
  { title: "Chuttu Chutti", file: "songs/Chuttu_Chutti.mp3" },
  { title: "Chuttu Janam", file: "songs/Chuttu_Janam.mp3" },
  { title: "Collagee Papala", file: "songs/Collagee_Papala.mp3" },
  { title: "Colorful Chilaka", file: "songs/Colorful_Chilaka.mp3" },
  { title: "Dammare Damma", file: "songs/Dammare_Damma.mp3" },
  { title: "Danda Kadiyal", file: "songs/Danda_Kadiyal.mp3" },
  { title: "Daredumdadum", file: "songs/Daredumdadum.mp3" },
  { title: "Deo Deo", file: "songs/Deo_Deo.mp3" },
  { title: "Desi Girl", file: "songs/Desi_Girl.mp3" },
  { title: "Devatalaaraa", file: "songs/Devatalaaraa.mp3" },
  { title: "Dhummu Dholi", file: "songs/Dhummu_Dholi.mp3" },
  { title: "Drunk and Drive", file: "songs/Drunk_and_Drive.mp3" },
  { title: "Eeswarude", file: "songs/Eeswarude.mp3" },
  { title: "Gana Gana", file: "songs/Gana_Gana.mp3" },
  { title: "Ghal Ghal Ghal Ghal", file: "songs/Ghal_Ghal_Ghal_Ghal.mp3" },
  { title: "Gira Gira Gira", file: "songs/Gira_Gira_Gira.mp3" },
  { title: "Glassmates", file: "songs/Glassmates.mp3" },
  { title: "Gopikamma", file: "songs/Gopikamma.mp3" },
  { title: "Gore Gore", file: "songs/Gore_Gore.mp3" },
  { title: "Gundellonaa", file: "songs/Gundellonaa.mp3" },
  { title: "Guruvaram", file: "songs/Guruvaram.mp3" },
  { title: "Guvva Gorinkatho", file: "songs/Guvva_Gorinkatho.mp3" },
  { title: "Hailo Hailessare", file: "songs/Hailo_Hailessare.mp3" },
  { title: "Hai Ra Hai Rabba", file: "songs/Hai_Ra_Hai_Rabba.mp3" },
  { title: "Hey Abbayi", file: "songs/Hey_Abbayi.mp3" },
  { title: "Hey Nenila", file: "songs/Hey_Nenila.mp3" },
  { title: "Hey Pillagaada", file: "songs/Hey_Pillagaada.mp3" },
  { title: "Hola Chica m", file: "songs/Hola_Chica_m.mp3" },
  { title: "Hrudayamane", file: "songs/Hrudayamane.mp3" },
  { title: "Hukum", file: "songs/Hukum.mp3" },
  { title: "Hunter Title", file: "songs/Hunter_Title.mp3" },
  { title: "Inkem Kaavaale", file: "songs/Inkem_Kaavaale.mp3" },
  { title: "ISM", file: "songs/ISM.mp3" },
  { title: "Janda Pai Kapiraju", file: "songs/Janda_Pai_Kapiraju.mp3" },
  { title: "Jeevitamante Poraat", file: "songs/Jeevitamante_Poraat.mp3" },
  { title: "Jigijikka", file: "songs/Jigijikka.mp3" },
  { title: "Jinthaak", file: "songs/Jinthaak.mp3" },
  { title: "Jum Jum Maya", file: "songs/Jum_Jum_Maya.mp3" },
  { title: "Just Chill Boss", file: "songs/Just_Chill_Boss.mp3" },
  { title: "Kaala Bhairava Ash", file: "songs/Kaala_Bhairava_Ash.mp3" },
  { title: "Kaatuka Kallu", file: "songs/Kaatuka_Kallu.mp3" },
  { title: "Kadile Kalama", file: "songs/Kadile_Kalama.mp3" },
  { title: "Kajalu Chelliva", file: "songs/Kajalu_Chelliva.mp3" },
  { title: "Kala Kala Kalamand", file: "songs/Kala_Kala_Kalamand.mp3" },
  { title: "Kalyani Vaccha Vach", file: "songs/Kalyani_Vaccha_Vach.mp3" },
  { title: "Kandi Chenu", file: "songs/Kandi_Chenu.mp3" },
  { title: "Kanureppala Kaalam", file: "songs/Kanureppala_Kaalam.mp3" },
  { title: "Kick", file: "songs/Kick.mp3" },
  { title: "Kilimanjaro", file: "songs/Kilimanjaro.mp3" },
  { title: "Kingulanti Singaman", file: "songs/Kingulanti_Singaman.mp3" },
  { title: "Koppamga Kopam", file: "songs/Koppamga_Kopam.mp3" },
  { title: "Koyilamma", file: "songs/Koyilamma.mp3" },
  { title: "Krishna Trance", file: "songs/Krishna_Trance.mp3" },
  { title: "Lets Party All Night", file: "songs/Lets_Party_All_Night.mp3" },
  { title: "Lokasamastha", file: "songs/Lokasamastha.mp3" },
  { title: "Lovely Lovely", file: "songs/Lovely_Lovely.mp3" },
  { title: "Maama Choodaro", file: "songs/Maama_Choodaro.mp3" },
  { title: "Maate Vinadhuga", file: "songs/Maate_Vinadhuga.mp3" },
  { title: "Mahanati", file: "songs/Mahanati.mp3" },
  { title: "Maha Adhbhutham", file: "songs/Maha_Adhbhutham.mp3" },
  { title: "Malleeswarive", file: "songs/Malleeswarive.mp3" },
  { title: "Mama O Chanda", file: "songs/Mama_O_Chanda.mp3" },
  { title: "Manakanna Podich", file: "songs/Manakanna_Podich.mp3" },
  { title: "Manasilaayo", file: "songs/Manasilaayo.mp3" },
  { title: "Marhaba", file: "songs/Marhaba.mp3" },
  { title: "Massu Maranam", file: "songs/Massu_Maranam.mp3" },
  { title: "Mass Biriyanim", file: "songs/Mass_Biriyanim.mp3" },
  { title: "Mass Raja", file: "songs/Mass_Raja.mp3" },
  { title: "Masthu Masthu", file: "songs/Masthu_Masthu.mp3" },
  { title: "Matalu Rani", file: "songs/Matalu_Rani.mp3" },
  { title: "Mellaga Tellarindoi", file: "songs/Mellaga_Tellarindoi.mp3" },
  { title: "Mila Mila", file: "songs/Mila_Mila.mp3" },
  { title: "Most Wanted", file: "songs/Most_Wanted.mp3" },
  { title: "Musthabai", file: "songs/Musthabai.mp3" },
  { title: "My Love Is Back", file: "songs/My_Love_Is_Back.mp3" },
  { title: "Naake Ne Nachesth", file: "songs/Naake_Ne_Nachesth.mp3" },
  { title: "Naalo Chilipi Kala", file: "songs/Naalo_Chilipi_Kala.mp3" },
  { title: "Naa B C Centerlu", file: "songs/Naa_B_C_Centerlu.mp3" },
  { title: "Nallanchu Thellache", file: "songs/Nallanchu_Thellache.mp3" },
  { title: "Namaste", file: "songs/Namaste.mp3" },
  { title: "Nammavemom", file: "songs/Nammavemom.mp3" },
  { title: "Nandalaala", file: "songs/Nandalaala.mp3" },
  { title: "Nannaya Raasina", file: "songs/Nannaya_Raasina.mp3" },
  { title: "Narasimha", file: "songs/Narasimha.mp3" },
  { title: "Nava Manmadhuda", file: "songs/Nava_Manmadhuda.mp3" },
  { title: "Na Roja Nuvve", file: "songs/Na_Roja_Nuvve.mp3" },
  { title: "Neetho Unte Chaalu", file: "songs/Neetho_Unte_Chaalu.mp3" },
  { title: "Nee Chitram Choosi", file: "songs/Nee_Chitram_Choosi.mp3" },
  { title: "Nenu Autovanni", file: "songs/Nenu_Autovanni.mp3" },
  { title: "Nijamena", file: "songs/Nijamena.mp3" },
  { title: "Nilavade", file: "songs/Nilavade.mp3" },
  { title: "Ninnila", file: "songs/Ninnila.mp3" },
  { title: "Notanki", file: "songs/Notanki.mp3" },
  { title: "Nuvvele Nuvvele", file: "songs/Nuvvele_Nuvvele.mp3" },
  { title: "Nuvve Nuvve", file: "songs/Nuvve_Nuvve.mp3" },
  { title: "Oka Laila Kosam", file: "songs/Oka_Laila_Kosam.mp3" },
  { title: "Oka Paru Mugguru", file: "songs/Oka_Paru_Mugguru.mp3" },
  { title: "Okkade Okkade", file: "songs/Okkade_Okkade.mp3" },
  { title: "O Kalala Kathala", file: "songs/O_Kalala_Kathala.mp3" },
  { title: "Pelli Pandhiri", file: "songs/Pelli_Pandhiri.mp3" },
  { title: "Pilla Nuvvuleni", file: "songs/Pilla_Nuvvuleni.mp3" },
  { title: "Poratameym", file: "songs/Poratameym.mp3" },
  { title: "Power Unnodu", file: "songs/Power_Unnodu.mp3" },
  { title: "Prathi Roju Pandage", file: "songs/Prathi_Roju_Pandage.mp3" },
  { title: "Prayathname", file: "songs/Prayathname.mp3" },
  { title: "Prema Vennela", file: "songs/Prema_Vennela.mp3" },
  { title: "Pulsar Bike", file: "songs/Pulsar_Bike.mp3" },
  { title: "Puttibhoomim", file: "songs/Puttibhoomim.mp3" },
  { title: "Raarandoi Veduka", file: "songs/Raarandoi_Veduka.mp3" },
  { title: "Raaye Raaye", file: "songs/Raaye_Raaye.mp3" },
  { title: "Ragile Ragile", file: "songs/Ragile_Ragile.mp3" },
  { title: "Rajula", file: "songs/Rajula.mp3" },
  { title: "Ra Raa Ra Ramaiah", file: "songs/Ra_Raa_Ra_Ramaiah.mp3" },
  { title: "Renuka", file: "songs/Renuka.mp3" },
  { title: "Reppal Dappul", file: "songs/Reppal_Dappul.mp3" },
  { title: "Rum Pum Bum", file: "songs/Rum_Pum_Bum.mp3" },
  { title: "Sankranthi Sandhall", file: "songs/Sankranthi_Sandhall.mp3" },
  { title: "Sannajaji", file: "songs/Sannajaji.mp3" },
  { title: "Saranga Dariyam", file: "songs/Saranga_Dariyam.mp3" },
  { title: "Savyasachi", file: "songs/Savyasachi.mp3" },
  { title: "Seatu Siragadham", file: "songs/Seatu_Siragadham.mp3" },
  { title: "Shailaja Reddy", file: "songs/Shailaja_Reddy.mp3" },
  { title: "Shambo Shiva", file: "songs/Shambo_Shiva.mp3" },
  { title: "Shatamanam Bhavati", file: "songs/Shatamanam_Bhavati.mp3" },
  { title: "Single Kingulamm", file: "songs/Single_Kingulamm.mp3" },
  { title: "Sommasilli Pothu", file: "songs/Sommasilli_Pothu.mp3" },
  { title: "Soodu Soodu", file: "songs/Soodu_Soodu.mp3" },
  { title: "Sreekaramm", file: "songs/Sreekaramm.mp3" },
  { title: "Sumagandhaala", file: "songs/Sumagandhaala.mp3" },
  { title: "Sur Super", file: "songs/Sur_Super.mp3" },
  { title: "Suttamla Soosi", file: "songs/Suttamla_Soosi.mp3" },
  { title: "Suvvi Suvvalamma", file: "songs/Suvvi_Suvvalamma.mp3" },
  { title: "Swamy Ra Ra", file: "songs/Swamy_Ra_Ra.mp3" },
  { title: "Taxi Vaala", file: "songs/Taxi_Vaala.mp3" },
  { title: "Telugammayi", file: "songs/Telugammayi.mp3" },
  { title: "Telugante", file: "songs/Telugante.mp3" },
  { title: "Teluse Nuvvu Ravani", file: "songs/Teluse_Nuvvu_Ravani.mp3" },
  { title: "Thalachi Thalachi", file: "songs/Thalachi_Thalachi.mp3" },
  { title: "Thanu Vethikina", file: "songs/Thanu_Vethikina.mp3" },
  { title: "Thirumala Vasa", file: "songs/Thirumala_Vasa.mp3" },
  { title: "Tingu Tingu Ranga", file: "songs/Tingu_Tingu_Ranga.mp3" },
  { title: "Toliprema", file: "songs/Toliprema.mp3" },
  { title: "Vachindamma", file: "songs/Vachindamma.mp3" },
  { title: "Vachinde", file: "songs/Vachinde.mp3" },
  { title: "Varinche Prema", file: "songs/Varinche_Prema.mp3" },
  { title: "Veede Veede", file: "songs/Veede_Veede.mp3" },
  { title: "Vijayaho", file: "songs/Vijayaho.mp3" },
  { title: "What The Life", file: "songs/What_The_Life.mp3" },
